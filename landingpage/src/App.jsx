      ...
      <header className="topbar">
        <div className="container nav-wrap">
          ...
          <div className="nav-actions">
            <a href="#contact" className="login-btn" onClick={(event) => scrollToSection(event, 'contact')}>
              Login
            </a>
            <button
              type="button"
      ...
      <main>
          ...
          <div className="container hero-grid">
            <div className="hero-copy">
              ...
              <div className="cta-row">
                <a href="#contact" className="primary-btn" onClick={(event) => scrollToSection(event, 'contact')}>
                  Get Started
                  <ArrowRight size={18} />
                </a>
        ...
        <section className="section-container cta-section">
          <div className="container cta-box">
            ...
            <a href="#contact" className="primary-btn cta-btn" onClick={(event) => scrollToSection(event, 'contact')}>
              Get Started
            </a>
          </div>
        </section>
